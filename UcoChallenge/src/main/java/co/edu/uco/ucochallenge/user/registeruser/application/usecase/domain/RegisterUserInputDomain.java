...
public final class RegisterUserInputDomain {
    ...
    public RegisterUserInputDomain(
        final UUID id,
        final UUID idType,
    ...
    public static RegisterUserInputDomain create(
        final UUID idType,
        final String idNumber,
        final String firstName,
        final String secondName,
        ...
        return new RegisterUserInputDomain(
            UUID.randomUUID(),
            idTypeValidated,
            idNumberValidated,
            firstNameValidated,
